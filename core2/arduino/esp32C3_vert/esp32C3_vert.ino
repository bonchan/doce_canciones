...
#define CAPS_PUBLISHES "[\"ldr_1\",\"ldr_2\",\"audio_playing\",\"audio_position_ms\",\"audio_duration_ms\"]"
...
const int ledPins[] = {5, 6, 7, 9, 10, 20, 21};
...
void loop() {
  ...
  ldr1value = analogRead(LDR_1_PIN);
  ldr2value = analogRead(LDR_2_PIN);
